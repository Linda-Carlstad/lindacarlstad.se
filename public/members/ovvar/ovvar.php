...
<img src="logo.png" class="img-responsive center-block">
    ...
    <option>XX-Large</option>
            ...
            <input type="submit" class=" form-control btn-success" name="skickaOrder">
                ...
                <div class="row">
                <p class="col-lg-5 bg-warning">KALLE KARLSSON</p>
                <p class="col-lg-2 bg-info">Betalat</p>
                <p class="col-lg-3 bg-success">Medium</p>
                <button class="btn-danger col-lg-2">TA BORT</button>
                </div>
                                    <div class="row">
                <p class="col-lg-5 bg-warning">KALLE KARLSSON</p>
                <p class="col-lg-2 bg-info">Betalat</p>
                <p class="col-lg-3 bg-success">Medium</p>
                <button class="btn-danger col-lg-2" id="taBort">TA BORT</button>
                </div>
                       <?php
...
$(".tabortKnapp").click(function(){
    ...
    $namn=$(this).siblings(':first-child').text();    
          $.ajax({
                url: 'http://localhost/ovvar/ajaxmeme.php',
                data: {namn: $namn},

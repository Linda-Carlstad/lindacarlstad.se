...
<html lang="<?php echo e(str_replace( '_', '-', app()->getLocale() )); ?>">
    <head>
        ...
        <title><?php echo e(config( 'app.name', 'Linda Carlstad' )); ?> - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <link href="<?php echo e(asset( 'img/icon.ico' )); ?>" rel="icon">
    </head>
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav navbar-nav w-100">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo e(route( 'about' )); ?>">Föreningen</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route( 'news' )); ?>">Nyheter</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="nav navbar-nav w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route( 'login' )); ?>"><?php echo e(__( 'Logga in' )); ?></a>
                        </li>
                        <li class="nav-item">
                            <?php if( Route::has( 'register' ) ): ?>
                            <a class="nav-link" href="<?php echo e(route( 'register' )); ?>"><?php echo e(__( 'Registrera' )); ?></a>
                            <?php endif; ?>
                        </li>
                        <?php else: ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-dark" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item bg-dark" href="<?php echo e(route( 'profile' )); ?>">Profile</a>
                                <a class="dropdown-item bg-dark" href="<?php echo e(route( 'logout' )); ?>"
                                    onclick="event.preventDefault();
                                    document.getElementById( 'logout-form' ).submit();">
                                <?php echo e(__( 'Logga ut' )); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3">
                        <p>
                            ...
                            651 68 Karlstad
                            <br>
                            <a href="<?php echo e(url( 'whoops' )); ?>" class="special">Whoops</a>
                        </p>
                    </div>
                    <div class="col-12 col-md-3">
                        <p>
                            ...
                            <!-- <a href="events.php">Event</a>
                                <br> -->
                            <a href="<?php echo e(route( 'document' )); ?>">Dokument</a>
                            <br>
                    ...
                    <div class="col-12 col-md-3">
                        <p>
                            ...
                            <br>
                            <a href="<?php echo e(route( 'about' )); ?>">Om oss</a>
                            <br>
                            <a href="<?php echo e(route( 'new-member' )); ?>.php">Bli medlem</a>
                            <br>
                            ...
                            <br>
                            <a href="<?php echo e(route( 'secret' )); ?>" class="special">Secret</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <script src="<?php echo e(asset( 'js/main.js' )); ?>" type="text/javascript" defer></script>

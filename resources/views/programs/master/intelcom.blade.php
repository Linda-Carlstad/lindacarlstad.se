...
@section( 'content' )
    ...
    <h1>Masterprogram i intelligenta kommunikationssystem</h1>
    <hr>
    <p>
        Inom datavetenskap går utvecklingen snabbt framåt. Därför inriktar sig programmet vid Karlstads universitet på att utrusta 
        studenten med en förmåga att kontinuerligt inhämta och tillämpa ny kunskap. Utbildningen syftar även till att studenterna ska 
        förvärva fördjupad kompetens inom det datavetenskapliga området med inriktning mot intelligenta kommunikationssystem.
    </p>
    ...
    <a rel="noreferrer" target="_blank" class="btn btn-grey" href="https://www.kau.se/utbildning/program-och-kurser/program/TAMIC">Läs mer</a>
    <hr>
